...
'''Bill Gates has an emergency. He would like you to prepare a list of items that he needs to take on his single passenger sailing boat on a trip around the world. Research the ten items you think would be most suited to a long solitary cruise around the world. Store the ten items in a list, and print out a list of the items using a for loop. Each iteration should use an fstring and the item name to list the items you have prepared, as part of a sentence. You will also need to iterate a number at the beginning of each sentence. Each sentence should print the following: 
Item 1 is... 
Item 2 is... and so on 
Following the loop, print a statement outside of the loop reminding Bill to make sure he takes all the items. Remember, this should print only once.
Copy all items to a new list and remove five of the items. Print out both lists.'''

items = ["phone", "clothing", "camera", "Passport", "Laptop", "Drugs", "Airpod", "watch", "Pants", "Books"]
num = 1 #to show first item
for item in items:
  print(f"item {num} is {item}")
  num = num + 1 # to show from second item
print("Bill Gate, make sure to take all the items with you.")
items_2 = items[:] #copying all items to a new list.
items_2 = items[:5] #removing five items from list.
print(items)
print(items_2)
...
#Question #2							
#############
'''Make a list of the number 1 to 1000 and use a for loop using range() to print the numbers. Then print min(), max() and sum() to find the smallest, largest, and combined total. Make sure to add your answers to your file using comments, In the comments, explain why you ended up with your beginning and ending numbers and what they were.'''

for numbers in range(1, 1001): #list of numbers from 1 to 1000.
  print(numbers)

number = range(1,1001) #to create a range as a list
print(min(number))#minimum 
print(max(number))#maximum 
print(sum(number))#total
# I used number 1001 so that the number range can return 1 to 1000 numbers 

#############								   	                  
#Question #3							
#############
'''Use the third argument of the range() function to make a list of odd numbers between 1 and 40. Use a for loop to print out the numbers. Make a second list of even numbers between 1 and 40 and print them out with a for loop. Finally, make a list of the multiples of 3 from 3 to 30, and print them out with a for loop.'''

for numbers in range(1,41,2): #odd numbers between 1 and 40.
  print(numbers)
for numbers in range (2,41,2):#even numbers between 1 and 40.
  print(numbers)
for numbers in range(3,31,3):#a list of the multiples of 3 from 3 to 30.
  print(numbers)

#############								   	                  
#Question #4							
#############
'''Dogs age 7 times faster than humans. Write a program that calculates your age in dog years. Store your age in a variable, perform the calculation, and print out a properly formatted sentence with your age in dog years using a join. Do not use an fstring. Remember to convert integers to strings and vice versa as needed.'''

myage = 27 #my age
dogage = 7 * myage #calculating my age in dog years.
print("My age in dog years is" , str(dogage))#printing with a comment without f string 

#############								   	                  
#Question #5						
#############

'''Store the last nine stock prices of a stock of your choice in a list. Using slices of the list, print out  sentences using an fstring calculating the total combined price (sum) of one share from the first three list entries, the sum of middle three prices, and the sum of the last three. Print the answers in three descriptive sentences, not just numerical values.'''

dangotestock = [100, 200, 300, 400, 500, 600, 900, 50, 40 ]#the last 9 stock prices
slice1 = dangotestock[0:3]#share from the first three
slice1sum = sum(slice1)
print(f'The sum of the first three stock is, {slice1sum}')

slice2 = dangotestock[3:6]#share with the middle three
slice2sum = sum(slice2)
print(f'The sum of the middle three stock is, {slice2sum}')

slice3 = dangotestock[6:9]#share with the las three
slice3sum = sum(slice3)
print(f'The sum of the last three stock is, {slice3sum}')

#############								   	                  
#Question #6							
#############
'''Scott Moe, the premier of Saskatchewan, would like to invite you to visit the all you can eat KFC in Weyburn, SK. https://www.ctvnews.ca/business/hidden-treasure-sask-kfc-buffet-to-stay-open-after-residents-rally-online-1.2916542 Make a list of five foods from KFC that you want to eat an endless amount of, and store them in a tuple. Use a for loop to print each one of the foods stored in the tuple. You can not update a tuple like a list, so replace two of the items in your list by overwriting the whole tuple. Add comments about how you think tuples and lists are different from each other.'''

kfcs = ("Rice", "Bagel", "Coke", "Chicken", "Tea")#storing a list in tuple.
for kfc1 in kfcs:
  print(kfc1)#Using a for loop to print each one of the foods stored in the tuple.
newkfcs = ("Beans", "Water", "Coke", "Chicken", "Tea")
for newkfc in newkfcs:
  print(newkfc)
#list is mutable, whereas a tuple is immutable. This means that lists can be changed, and tuples cannot be changed. We can replace two of the items by overwriting the whole tuple.

'''Bonus Question:

Using the bangladesh.py (monthly average value of Bangladesh temperature and rain from 1901 to 2015) (file attached), copy the list into your code and use the statistics package (remember to import it) to calculate and have your program print out the min, max, standard deviation, the mean and the median for the data. This is the file you have to use.'''


#This file contains the monthly average value of Bangladesh temperature and rain from 1901 to 2015
...
print(min(weather))#minimum number.
print(max(weather)) #maximum number.
import statistics
print(statistics.mean(weather)) #calculating mean.
print(statistics.stdev(weather)) #calculating standard deviation.
print(statistics.median(weather)) #calculating median.


ann = [17,19,3,19,13,2,6,11,20,20,4,20,20,10,17]
for ann in range (1, 3):
 print(ann)
